...
function mkForm($action="",$method="get",$class="")
{
...
function mkInput($type,$name,$value="",$class="",$style="",$id="",$placeholder="")
{
	// Produit un champ formulaire
	echo "<input type=\"$type\" name=\"$name\" value=\"$value\" class=\"$class\" style=\"$style\" id=\"$id\" placeholder=\"$placeholder\" />\n";
}

function mkbutton($class, $type,$name,$value="")
{
	// Produit un champ formulaire
	echo "<button class=\'$class\' type=\"$type\" name=\"$name\" value=\"$value\"/>\n";
}
